...
const CreateContestTimingVotingOpens = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-base font-bold text-neutral-9 uppercase italic">voting opens</p>
      <div className="flex flex-wrap items-center gap-4">
        {/* the three read as one date, so they share a row on mobile and the note below wraps under them */}
