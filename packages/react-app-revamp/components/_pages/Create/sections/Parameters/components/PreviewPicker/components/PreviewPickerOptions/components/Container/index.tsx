...
const CreateContestEntriesPreviewPickerOptionsContainer: FC<CreateContestEntriesPreviewPickerOptionsContainerProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col w-full h-[200px] md:h-[260px] gap-2 md:gap-4 p-2 md:p-4 rounded-xl md:rounded-2xl bg-true-black border cursor-pointer overflow-hidden ${
