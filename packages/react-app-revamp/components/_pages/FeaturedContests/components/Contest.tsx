...
const FeaturedContestCard: FC<FeaturedContestCardProps> = ({ contestData, rewardsData, isRewardsFetching }) => {
  ...
  return (
    <div className="relative flex flex-col gap-3 p-4 w-full md:w-80 rounded-2xl border border-neutral-7 bg-[#141414] hover:border-neutral-10 transition-colors duration-200 animate-appear">
      <CardHeader
